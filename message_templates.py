message_templates = {
    "en": {
        "start": "Hello, I'm bot powered on API GPT-3.5(ChatGPT). Enter /help",
        "new_topic": "Starting a new topic!",
        "about": "This bot is powered by OpenAI GPT-3.5.",
    ...
    "ru": {
        "start": "Привет, я бот, работающий на API GPT-3.5(ChatGPT). Введите /help",
        "new_topic": "Начинаем новую тему!",
        "about": "Этот бот работает на OpenAI GPT-3.5.",
        ...
        "language_selection": "Доступно на 2 языках:",
